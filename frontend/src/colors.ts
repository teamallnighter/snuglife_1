...
export const colorBgBase = 'bg-neonGreenTheme-mainBG';
...
export const colorsBgLight = {
  ...
  light:
    ' bg-neonGreenTheme-outsideCardColor text-primaryText text-primaryText dark:bg-dark-900 dark:text-white',
...
export const getButtonColor = (
  ...
  const colors = {
    ring: {
      ...
      whiteDark: 'ring-neonGreenTheme-outsideCardColor  dark:ring-dark-500',
      lightDark: 'ring-gray-200 dark:ring-gray-500',
      contrast: 'ring-gray-300 dark:ring-gray-400',
      success: 'ring-emerald-300 dark:ring-pavitra-blue',
      danger: 'ring-red-300 dark:ring-red-700',
      warning: 'ring-yellow-300 dark:ring-yellow-700',
      info: 'ring-neonGreenTheme-buttonColor dark:ring-pavitra-blue',
    },
    active: {
      white: 'bg-gray-100',
      ...
      info: 'bg-neonGreenTheme-buttonColor  dark:bg-pavitra-blue',
    },
    bg: {
      white: 'bg-white text-black',
      whiteDark:
        'bg-neonGreenTheme-outsideCardColor   text-primaryText  dark:bg-dark-900 dark:text-white',
    ...
    bgHover: {
      ...
      whiteDark:
        'hover:bg-neonGreenTheme-outsideCardColor   hover:dark:bg-dark-800',
      ...
      info: 'hover:bg-neonGreenTheme-800  hover:border-neonGreenTheme-buttonColor hover:text-primaryText hover:dark:bg-pavitra-blue/80 hover:dark:border-pavitra-blue/80',
    },
    borders: {
      white: 'border-white',
      whiteDark:
        'border-neonGreenTheme-outsideCardColor   dark:border-dark-900',
      lightDark: 'border-gray-100 dark:border-slate-800',
      contrast: 'border-gray-800 dark:border-white',
      success: 'border-emerald-600 dark:border-pavitra-blue',
      danger: 'border-red-600 dark:border-red-500',
      warning: 'border-yellow-600 dark:border-yellow-500',
      info: 'border-neonGreenTheme-buttonColor  border-blue-600 dark:border-pavitra-blue',
    },
    text: {
    ...
    outlineHover: {
      ...
      info: 'hover:bg-neonGreenTheme-buttonColor text-neonGreenTheme-buttonColor  hover:bg-blue-600 hover:text-white hover:dark:text-white hover:dark:border-pavitra-blue',
    },
  };
