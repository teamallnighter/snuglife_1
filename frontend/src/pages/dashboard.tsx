...
const Dashboard = () => {
  ...
  const [variations, setVariations] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        >
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiTshirtCrew || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
          ...
          {hasPermission(currentUser, 'READ_VARIATIONS') && (
                ...
                <div className='flex justify-between align-center'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiPalette || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
